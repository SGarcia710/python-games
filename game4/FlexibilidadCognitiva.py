...
from game4.InstruccionesNivelUno import *
from game4.InstruccionesNivelDos import *

class FlexibilidadCognitiva:
  def __init__(self, menuWindow):  
    self.menuWindow = menuWindow
    self.rootWindow = Tk()
    self.rootWindow.title("Flexibilidad Cognitiva")
    ...
    self.title = Label(self.rootWindow, text = "MENÚ FLEX. COGNITIVA", bg = "white")
