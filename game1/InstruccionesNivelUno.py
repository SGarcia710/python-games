...
class InstruccionesNivelUno:
  def __init__(self, window):
    ...
    string1 = "Este nivel tiene 20 rondas. En cada ronda el"
    string2 = "jugador deberá presionar el botón [Go] cuando"
    string3 = "aparezcan Globos rojos en la pantalla. De lo"
    string4 = "contrario, el jugador deberá esperar a que cambie"
    string5 = "a la siguiente ronda."
    string6 = ""
